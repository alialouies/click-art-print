  ...
  const artData = async () => {
    try {
      const res = await axios.get(
        "https://www.rijksmuseum.nl/api/nl/collection?key=eQKm0Vx6&culture=en&involvedMaker=George%20Barbier&imgonly=True"
      );
      const artArray = [];
  ...
  return (
    <div>
      <div className="intro">
        ...
        <h2>
          featuring french artist and illustrator Charles Martin (1884–1934)
        </h2>
      </div>
